...
const Project: React.FC<FeatureGridSectionProps> = ({
  ...
  return (
    <section
      className={`w-full  flex items-center px-4 py-16 md:px-6 lg:px-10 xl:px-16 2xl:px-20 ${background}`}
    >
      <div className="max-w-8xl mx-auto w-full">
        {/* Responsive Title */}
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-12 text-center text-black leading-snug">
          {title}
        </h2>
