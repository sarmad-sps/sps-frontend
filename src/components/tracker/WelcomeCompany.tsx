  ...
  return (
    <section className="bg-[#1C4D8D] py-16 w-full px-4 md:px-10 lg:px-10 xl:px-16 2xl:px-18 relative overflow-hidden">
      <div className="max-w-8xl mx-auto">
        {/* Desktop + Tablet: Flex Row (Images + Text) */}
        {/* Mobile: Only Text (Images Hidden) */}
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          
          {/* LEFT: Images Section - HIDDEN ON MOBILE */}
          <div className="hidden lg:block relative w-full lg:w-1/2 h-[550px] flex items-center justify-center">
            {/* Bottom Left Image */}
            ...
            <img
              src="/car.png"
              alt="Car behind images"
              className="absolute bottom-[70px] right-[-20px] w-56 object-contain rotate-[-5deg]"
              style={{ zIndex: 5 }}
            />
            ...
            <div className="absolute top-10 left-20 
              ...
              <span className="text-4xl block mb-1 drop-shadow-md">50+</span>
              <span className="leading-tight opacity-90 tracking-wide uppercase text-sm">
                Years of <br /> Experience
              </span>
            </div>
          </div>

          {/* RIGHT: Text Section - ALWAYS VISIBLE (Mobile + Desktop) */}
          <div className="w-full lg:w-1/2 lg:pl-16 text-center lg:text-left">
            <p className="flex items-center justify-center lg:justify-start gap-2 text-[#00B5AD] font-semibold mb-4 text-sm">
              <img
                src="/splogo.png"
                alt="SP Logo"
                className="w-6 h-6 object-contain"
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-6 mt-10">
              ...
              <div className="flex items-center text-[#ffff] font-semibold">
                <Phone className="w-5 h-5 mr-2 text-[#ffff]" />
                <span>
                  Call Anytime <br className="sm:hidden" /> 03008492075
                </span>
              </div>
            </div>
          </div>
