...
const testimonialsData: Testimonial[] = [
  {
    id: 1,
    quote:
      "Their GPS tracking accuracy is outstanding. I can monitor all my vehicles in real-time without delays. Highly recommended for fleet owners!",
    name: "Ahmed Khan",
    title: "Fleet Manager",
    rating: 5,
  ...
  },
  {
    id: 2,
    quote:
      "The instant alerts feature has saved us multiple times from unauthorized vehicle movement. Excellent service and reliable support team!",
    name: "Sarah Malik",
  ...
  },
  {
    id: 3,
    quote:
      "I love the detailed trip history and fuel monitoring. Helps us reduce costs and improve driver performance. Great experience so far.",
    name: "Usman Raza",
  ...
  },
  {
    id: 4,
    quote:
      "Best tracking solution I’ve used! The mobile app is smooth and provides every detail I need on the go.",
    name: "Huma Yousaf",
  ...
  },
  {
    id: 5,
    quote:
      "Their customer service is excellent. Whenever we needed help setting up devices, their team responded instantly.",
    name: "Zain Shah",
    title: "Administrator",
    rating: 5,
    // imageSrc: "/testimonial2.jpg",
  },
  {
    id: 6,
    quote:
      "Vehicle security has improved a lot after installing their tracker. Real-time notifications are very helpful.",
    name: "Maria Ali",
    title: "Customer",
    rating: 4,
    // imageSrc: "/testimonial3.jpg",
  },
  {
    id: 7,
    quote:
      "Their platform is simple to use yet powerful. Highly satisfied with the performance and tracking speed.",
    name: "Bilal Akhtar",
  ...
  },
  {
    id: 8,
    quote:
      "Affordable pricing with premium tracking features. It’s definitely worth the investment for vehicle safety.",
    name: "Nimra Faisal",
    title: "Customer",
    rating: 5,
    // imageSrc: "/testimonial2.jpg",
...
const StarIcon: React.FC<{ filled: boolean }> = ({ filled }) => (
  <svg
    className={`w-5 h-5 ${filled ? "text-[#1894A4]" : "text-gray-300"}`}
    fill="currentColor"
    viewBox="0 0 20 20"
  >
...
const TestimonialCard: React.FC<{ testimonial: Testimonial }> = ({
  ...
  const stars = Array(5)
    .fill(false)
    .map((_, i) => i < testimonial.rating);

  return (
    <div
      className="bg-white rounded-xl flex flex-col h-full relative overflow-hidden
