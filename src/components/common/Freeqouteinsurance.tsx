      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col gap-4 pt-6">
          ...
          <button
            onClick={handleConfirm}
            disabled={loading}
            className={`relative w-full px-8 py-4 rounded-xl font-bold flex items-center justify-center gap-3 overflow-hidden transition-all duration-300 
              bg-gradient-to-r from-[#1A3970] to-[#2ba9b4] text-white 
              hover:shadow-[0_0_15px_rgba(26,57,112,0.5)] hover:scale-102 active:scale-95 
              ${loading ? "opacity-60 cursor-not-allowed" : ""} group`}
          >
            ...
            <span className="absolute inset-0 bg-gradient-to-r from-[#1A3970] to-[#2ba9b4] opacity-0 rounded-xl transition-opacity duration-500 animate-pulse group-hover:opacity-20 pointer-events-none"></span>
    ...
    <div className="bg-white rounded-2xl shadow-2xl overflow-hidden border-4 border-[#1894a4]">
      <div className="bg-gradient-to-r from-[#1894a4] to-[#117a8b] p-6 text-white text-center">
        ...
        <p className="text-lg mt-2 opacity-90">
          {selectedQuote!.insurancePlan}
        </p>
      </div>
      <div className="p-6 bg-gray-50 text-center">
        <p className="text-4xl font-bold text-[#1A3970]">
          {selectedQuote!.total}
        </p>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="block lg:hidden space-y-10">
          ...
          <div className="text-center">
            <h3 className="text-2xl font-bold text-[#1A3970] mb-6">
              Your Selected Plan
            </h3>
            {selectedQuote ? (
          ...
          {/* Form Section */}
          <div className="space-y-6">
            <h2 className="text-3xl font-bold text-[#1A3970] text-center">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-green-600">
                      RS {initialVehicleInfo.currentValue}
                    </p>
                  </div>
                  <div>
        ...
        <div className="hidden lg:grid lg:grid-cols-2 gap-12">
          {/* Left Side - Form */}
          <div className="space-y-6">
            <h2 className="text-3xl font-bold text-[#1A3970]">
              Complete Your Request
            </h2>
            ...
            {selectedQuote ? (
              ...
              <div className="bg-gray-100 border-2 border-dashed border-gray-300 rounded-2xl p-10 text-center">
                ...
                <p className="text-sm text-gray-400 mt-2">
                  Please go back and choose an insurance plan
                </p>
              </div>
            )}
          </div>
