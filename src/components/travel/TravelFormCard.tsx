...
const TravelFormCard = () => {
  ...
  const handleSubmit = async () => {
    ...
    // Simulate delay for spinner & toast
    setTimeout(() => {
      try {
  ...
  return (
    <div className="w-full px-4 md:px-10 lg:px-10 xl:px-16 2xl:px-18 py-8"   id="quote-form">
      <div className="bg-white rounded-2xl shadow-2xl p-6 md:p-8 space-y-6">
        {/* Name */}
        <div>
          <label className="block text-sm font-bold text-gray-700 mb-2">Name</label>
        ...
        <div className="relative">
          ...
          {errors.countryToTravel && <p className="text-red-500 text-sm mt-1">{errors.countryToTravel}</p>}
        </div>
