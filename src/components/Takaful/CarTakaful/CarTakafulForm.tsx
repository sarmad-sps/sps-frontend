...
const CarTakafulForm: React.FC = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.currentValue.trim())
      newErrors.currentValue = "Enter current value";
    setErrors(newErrors);
  ...
  return (
    <div className="bg-[#F9FBFF] p-10 rounded-lg shadow-md max-w-7xl mx-auto relative">
      {/* Step Indicator */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="relative">
          ...
          <input
            ...
            } rounded-md px-4 py-3 cursor-pointer bg-white focus:ring-2 focus:ring-[#1A3970] outline-none`}
          />
          <Calendar
            className="absolute right-4 top-[45px] w-5 h-5 text-gray-500 pointer-events-none"
          />
          {showCalendar && (
        ...
        <div className="mt-12">
          ...
          <div className="mt-6 flex justify-center">
            <button
              ...
              onClick={() => {
                navigate("/quote-insurance", { state: { formData, selectedCard } });
              }}
